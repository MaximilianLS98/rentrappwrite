...
export function PropertyOverview({ totalProperties, totalUnits, totalRevenue, totalTenants, properties, units }: PropertyOverviewProps) {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{totalRevenue}NOK *Dummydata</div>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          <div className="text-2xl font-bold">{totalTenants} *Dummydata</div>
        </CardContent>
      </Card>
    </div>
  )
